          ...
          {countries.map((country, key) => (
            <div>
              <div
                ...
                className="sm:p-2 md:p-3  sm:mt-2 md:m-2 md: lg: sm:ml-6 sm:w-[80vw] md:w-[50vw] lg:w-[20vw]"
              >
                <img
                ...
                {country.name.official ? country.name.official : "No data"}
                <br />
                <strong>Continent:</strong>{" "}
                {country.continents ? country.continents : "No data"}
                <br />
                ...
                {country.borders ? country.borders.join(", ") : "No data"}
                <br />
                <strong>Area:</strong> {country.area ? country.area : "No data"}
                <br />
                <strong>Population:</strong>{" "}
                {country.population ? country.population : "No data"}
                <br />
