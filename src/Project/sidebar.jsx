...
const SideBar = () => {
  ...
  return (
    <div
      className={`sm:h-screen md:h-screen lg:h-screen bg-sideBarColor`}
    >
        ...
        <div>
          <Link to="/neighbours">
            <h4
              ...
              className={` sm:text-[12px] lg:text-[20px] sm:leading-none lg:block mt-[30px]  text-text lg:ml-[5px] sm:ml-[5px] hover:text-blue  `}
            >
              Find Neighbours
            </h4>
          </Link>
